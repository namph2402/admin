...
(function (global, factory) {
 true ? module.exports = factory(function() { try { return __webpack_require__("./node_modules/moment/moment.js"); } catch(e) { } }()) :
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__dashboard_service__ = __webpack_require__("./src/app/modules/dashboard/dashboard.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_chart_js__ = __webpack_require__("./node_modules/chart.js/dist/Chart.js");
...
var DashboardComponent = /** @class */ (function (_super) {
    ...
    function DashboardComponent(service, modal, builder) {
        ...
        _this.searchControls[1].data = _this.year;
        return _this;
    }
    ...
    DashboardComponent.prototype.getCreateModalComponent = function () {
    };
    DashboardComponent.prototype.getCreateModalComponentOptions = function () {
        return null;
    };
    DashboardComponent.prototype.getEditModalComponent = function () {
    };
    DashboardComponent.prototype.getEditModalComponentOptions = function () {
        return null;
    };
    DashboardComponent.prototype.getTitle = function () {
        return 'Bảng điều khiển';
    };
    DashboardComponent.prototype.initNewModel = function () {
        return null;
    };
    DashboardComponent.prototype.buildSearchForm = function () {
        return this.formBuilder.group({
            month: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormControl"](__WEBPACK_IMPORTED_MODULE_7_moment__(new Date().getTime()).format('MM')),
            year: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormControl"](__WEBPACK_IMPORTED_MODULE_7_moment__(new Date().getTime()).format('YYYY')),
        });
    };
    DashboardComponent.prototype.initSearchForm = function () {
        return [
            __WEBPACK_IMPORTED_MODULE_6__core__["h" /* FieldForm */].createSelect('Tìm kiếm tháng', 'month', 'Tháng', [
                {
                    name: 'Tháng 1',
                    value: '01',
                },
            ...
            __WEBPACK_IMPORTED_MODULE_6__core__["h" /* FieldForm */].createSelect('Tìm kiếm năm', 'year', 'Năm', []),
        ];
    };
    DashboardComponent.prototype.load = function () {
        var _this = this;
        var param = __WEBPACK_IMPORTED_MODULE_6__core__["j" /* ObjectUtil */].combineValue({}, this.searchForm.value, true);
        this.service.loadByParams(param).subscribe(function (val) {
            _this.boxes = val['boxes'];
            _this.products = val['products'];
            _this.orders = val['orders'];
            _this.percent = val['percents'];
            _this.quantityOrder = val['quantity'];
            _this.productCodeMains = val['productCodeMains'];
            _this.productQuantityMains = val['productQuantityMains'];
            _this.userMains = val['user'];
            _this.expense = val['expenses'];
            setTimeout(function () {
                ...
                if (_this.productCodeMains.length > 0) {
                    document.getElementById("productDiv").innerHTML = "<canvas id=\"product\"></canvas>";
                    new __WEBPACK_IMPORTED_MODULE_5_chart_js__["Chart"]("product", {
                        type: 'doughnut',
                        data: {
                            labels: _this.productCodeMains,
                            datasets: [{
                                    label: 'Sản phẩm',
                                    data: _this.productQuantityMains,
                                    backgroundColor: [
                                        'rgb(224, 3, 58)',
                                        'rgb(54, 162, 235)',
                                        'rgb(255, 241, 110)',
                ...
                new __WEBPACK_IMPORTED_MODULE_5_chart_js__["Chart"]("order", {
                    type: 'bar',
                    data: {
                        labels: ['T.1', 'T.2', 'T.3', 'T.4', 'T.5', 'T.6', 'T.7', 'T.8', 'T.9', 'T.10', 'T.11', 'T.12'],
                        datasets: [{
                                label: 'Đơn hàng bán',
                                data: _this.quantityOrder,
                ...
                new __WEBPACK_IMPORTED_MODULE_5_chart_js__["Chart"]("amount", {
                    type: 'line',
                    data: {
                        datasets: [{
                                label: 'Doanh thu',
    ...
    DashboardComponent.prototype.export = function (filename) {
        var _this = this;
        var param = __WEBPACK_IMPORTED_MODULE_6__core__["j" /* ObjectUtil */].combineValue({}, this.searchForm.value, true);
        this.service.export(param).subscribe(function (blob) {
            __WEBPACK_IMPORTED_MODULE_6__core__["g" /* ExcelHelper */].exportXLSXFile(blob, filename + "_" + __WEBPACK_IMPORTED_MODULE_6__core__["f" /* DateTimeUtil */].today('YYYY_MM_DD_X'));
            _this.service.toastSuccessfully('Xuất file', 'Thành công');
        });
    };
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__dashboard_service__["a" /* DashboardService */],
...
var DashboardService = /** @class */ (function (_super) {
    ...
    function DashboardService(http, toaster, title) {
        return _super.call(this, http, title, toaster, 'bảng điều khiển', 'dashboard') || this;
    }
