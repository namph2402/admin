...
CKEDITOR.lang['ja'] = {
  ...
  "bidi": {"ltr": "テキストの向き : 左から右へ", "rtl": "テキストの向き : 右から左へ"},
  ...
  "colorbutton": {
    "auto": "自動", "bgColorTitle": "背景色", "colors": {
      "000": "Black",
      "800000": "Maroon",
      "8B4513": "Saddle Brown",
      ...
      "7F8C8D": "Grayish Cyan",
      "999": "Dark Gray"
    }, "more": "その他の色...", "panelTitle": "色", "textColorTitle": "文字色"
  },
  "colordialog": {
    "clear": "クリア",
    "highlight": "ハイライト",
  ...
  "font": {
    "fontSize": {"label": "サイズ", "voiceLabel": "フォントサイズ", "panelTitle": "フォントサイズ"},
    "label": "フォント",
    "panelTitle": "フォント",
    "voiceLabel": "フォント"
  },
  "fakeobjects": {"anchor": "アンカー", "hiddenfield": "不可視フィールド", "iframe": "IFrame", "unknown": "Unknown Object"},
  "forms": {
    "button": {
      "title": "ボタン プロパティ",
      "text": "テキスト (値)",
    ...
    "hidden": {"title": "不可視フィールド プロパティ", "name": "名前 (name)", "value": "値 (value)"},
    "select": {
      "title": "選択フィールドのプロパティ",
      "selectInfo": "情報",
      "opAvail": "利用可能なオプション",
  ...
  "smiley": {"options": "絵文字オプション", "title": "顔文字挿入", "toolbar": "絵文字"},
