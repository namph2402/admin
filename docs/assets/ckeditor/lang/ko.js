...
CKEDITOR.lang['ko'] = {
  ...
  "bidi": {"ltr": "텍스트 방향이 왼쪽에서 오른쪽으로 ", "rtl": "텍스트 방향이 오른쪽에서 왼쪽으로"},
  ...
  "colordialog": {"clear": "비우기", "highlight": "강조", "options": "색상 옵션", "selected": "선택된 색상", "title": "색상 선택"},
  "templates": {
    "button": "템플릿",
  ...
  "font": {
    "fontSize": {"label": "크기", "voiceLabel": "글자 크기", "panelTitle": "글자 크기"},
    "label": "글꼴",
    "panelTitle": "글꼴",
    "voiceLabel": "글꼴"
  },
  "fakeobjects": {"anchor": "책갈피", "hiddenfield": "숨은 입력 칸", "iframe": "아이프레임", "unknown": "알 수 없는 객체"},
  "forms": {
    "button": {
      "title": "버튼 속성",
      "text": "글자 (값)",
    ...
    "form": {"title": "폼 속성", "menu": "폼 속성", "action": "실행 경로(Action)", "method": "방법(Method)", "encoding": "인코딩"},
  ...
  "smiley": {"options": "이모티콘 옵션", "title": "이모티콘 삽입", "toolbar": "이모티콘"},
  ...
  "specialchar": {"options": "특수문자 옵션", "title": "특수문자 선택", "toolbar": "특수문자 삽입"},
  "scayt": {
