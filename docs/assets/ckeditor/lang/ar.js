...
CKEDITOR.lang['ar'] = {
  ...
  "bidi": {"ltr": "إتجاه النص من اليسار إلى اليمين", "rtl": "إتجاه النص من اليمين إلى اليسار"},
  ...
  "colorbutton": {
    "auto": "تلقائي", "bgColorTitle": "لون الخلفية", "colors": {
      "000": "أسود",
      "800000": "كستنائي",
      "8B4513": "بني فاتح",
      ...
      "7F8C8D": "Grayish Cyan",
      "999": "رمادي غامق"
    }, "more": "ألوان إضافية...", "panelTitle": "Colors", "textColorTitle": "لون النص"
  },
  "colordialog": {
    "clear": "مسح",
    "highlight": "تحديد",
  ...
  "copyformatting": {
    "label": "نسخ التنسيق",
    "notification": {
      "copied": "تم نسخ التنسيق",
      "applied": "تم تطبيق التنسيق",
      "canceled": "تم الغاء التنسيق",
  ...
  "fakeobjects": {"anchor": "إرساء", "hiddenfield": "إدراج حقل خفي", "iframe": "iframe", "unknown": "عنصر غير معروف"},
  "forms": {
    "button": {
  ...
  "smiley": {"options": "خصائص الإبتسامات", "title": "إدراج ابتسامات", "toolbar": "ابتسامات"},
