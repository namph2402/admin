...
CKEDITOR.lang['ro'] = {
  ...
  "bidi": {"ltr": "Direcția textului de la stânga la dreapta", "rtl": "Direcția textului de la dreapta la stânga"},
  ...
  "colorbutton": {
    "auto": "Automat", "bgColorTitle": "Coloarea fundalului", "colors": {
      "000": "Negru",
      "800000": "Maro închis",
      "8B4513": "Maro închis",
  ...
  "copyformatting": {
    "label": "Copiere formatare",
    "notification": {
      "copied": "Formatare copiată",
      "applied": "Formatare aplicată",
      "canceled": "Formatare anulată",
      "failed": "Formatare greșită. Nu poți aplica stiluri fără a le copia întâi."
    }
  },
  "div": {
    "IdInputLabel": "Id",
  ...
  "font": {
    "fontSize": {"label": "Mărime", "voiceLabel": "Font Size", "panelTitle": "Mărime"},
    "label": "Font",
    "panelTitle": "Font",
    "voiceLabel": "Font"
  },
  ...
  "forms": {
    ...
    "hidden": {"title": "Proprietăţi câmp ascuns (Hidden Field)", "name": "Nume", "value": "Valoare"},
    "select": {
    ...
    "textarea": {"title": "Proprietăţi suprafaţă text (Textarea)", "cols": "Coloane", "rows": "Linii"},
    "textfield": {
  ...
  "pagebreak": {"alt": "Page Break", "toolbar": "Inserează separator de pagină (Page Break)"},
  "pastetext": {
