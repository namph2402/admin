...
CKEDITOR.lang['tt'] = {
  ...
  "colorbutton": {
    "auto": "Автоматик", "bgColorTitle": "Фон төсе", "colors": {
      "000": "Кара",
      "800000": "Бордо",
      "8B4513": "Дарчин",
      "2F4F4F": "Аспид соры",
      ...
      "7F8C8D": "Grayish Cyan",
      "999": "Dark Gray"
    }, "more": "Башка төсләр...", "panelTitle": "Төсләр", "textColorTitle": "Текст төсе"
  },
  "colordialog": {
    "clear": "Бушату",
    "highlight": "Билгеләү",
  ...
  "font": {
    "fontSize": {"label": "Зурлык", "voiceLabel": "Шрифт зурлыклары", "panelTitle": "Шрифт зурлыклары"},
    "label": "Шрифт",
    "panelTitle": "Шрифт исеме",
    "voiceLabel": "Шрифт"
  },
  "fakeobjects": {"anchor": "Якорь", "hiddenfield": "Яшерен кыр", "iframe": "IFrame", "unknown": "Танылмаган объект"},
  "forms": {
    "button": {
    ...
    "textarea": {"title": "Текст мәйданы үзлекләре", "cols": "Баганалар", "rows": "Юллар"},
    "textfield": {
  ...
  "smiley": {"options": "Смайл көйләүләре", "title": "Смайл өстәү", "toolbar": "Смайл"},
