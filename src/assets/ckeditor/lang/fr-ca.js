...
CKEDITOR.lang['fr-ca'] = {
  ...
  "bidi": {"ltr": "Direction du texte de gauche à droite", "rtl": "Direction du texte de droite à gauche"},
  ...
  "colorbutton": {
    "auto": "Automatique", "bgColorTitle": "Couleur de fond", "colors": {
      ...
      "7F8C8D": "Grayish Cyan",
      "999": "Dark Gray"
    }, "more": "Plus de couleurs...", "panelTitle": "Couleurs", "textColorTitle": "Couleur de texte"
  },
  "colordialog": {
    "clear": "Effacer",
    "highlight": "Surligner",
  ...
  "fakeobjects": {"anchor": "Ancre", "hiddenfield": "Champ caché", "iframe": "IFrame", "unknown": "Objet inconnu"},
  "forms": {
    "button": {
    ...
    "hidden": {"title": "Propriétés du champ caché", "name": "Nom", "value": "Valeur"},
    "select": {
    ...
    "textarea": {"title": "Propriétés de la zone de texte", "cols": "Colonnes", "rows": "Lignes"},
    "textfield": {
  ...
  "smiley": {"options": "Options d'émoticônes", "title": "Insérer un émoticône", "toolbar": "Émoticône"},
  ...
  "pagebreak": {"alt": "Saut de page", "toolbar": "Insérer un saut de page à l'impression"},
  "pastetext": {
