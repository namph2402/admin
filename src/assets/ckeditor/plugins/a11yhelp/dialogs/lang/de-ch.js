...
CKEDITOR.plugins.setLang("a11yhelp", "de-ch", {
  ...
  legend: [{
    ...
    name: "Befehle",
    items: [{name: "Rückgängig-Befehl", legend: "Drücken Sie ${undo}"}, {
