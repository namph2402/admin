...
CKEDITOR.dialog.add("specialchar", function (h) {
  var f, n = h.lang.specialchar, k, l, p, d, e, q;
  l = function (c) {
    var b;
  ...
  q = CKEDITOR.tools.addFunction(function (c) {
    ...
    switch (a) {
      ...
      case 32:
        ...
        break;
      case r ? 37 : 39:
        if (a = b.getParent().getNext()) a = a.getChild(0), 1 == a.type ? (a.focus(), d(null, b), e(null, a), c.preventDefault(!0)) : d(null, b); else if (a = b.getParent().getParent().getNext()) (a = a.getChild([0, 0])) && 1 == a.type ? (a.focus(), d(null, b), e(null, a), c.preventDefault(!0)) : d(null, b);
        break;
      case r ? 39 : 37:
        (a = b.getParent().getPrevious()) ? (a = a.getChild(0), a.focus(), d(null, b), e(null, a), c.preventDefault(!0)) : (a = b.getParent().getParent().getPrevious()) ? (a = a.getLast().getChild(0), a.focus(), d(null, b), e(null, a), c.preventDefault(!0)) :
          d(null, b)
    }
  });
  return {
    ...
    contents: [{
      ...
      elements: [{
        ...
        widths: ["320px", "90px"],
        children: [{
          type: "html", id: "charContainer", html: "", onMouseover: e, onMouseout: d, focus: function () {
        ...
        },
          {
            type: "hbox", align: "top", widths: ["100%"], children: [{
              type: "vbox",
              align: "top",
              children: [{type: "html", html: "\x3cdiv\x3e\x3c/div\x3e"}, {
                type: "html",
                id: "charPreview",
